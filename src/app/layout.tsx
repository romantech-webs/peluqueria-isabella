  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="peluqueria-isabella";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Peluquería isabella"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="peluqueria-isabella"
          data-primary-color="#a78964"
          defer
        ></script>
      </head>
